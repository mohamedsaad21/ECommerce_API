        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 8, 1, "Wireless Bluetooth earbuds with microphone", "AirPods", 95.99m, 155 },
                    { 9, 5, "Casual star-patterned sports shoes", "Star Shoes", 195.99m, 114 },
                    { 10, 1, "128GB storage, dual camera", "Smartphone", 599.99m, 70 },
                    { 11, 1, "Fitness tracking, heart rate monitor", "Smartwatch", 199.99m, 45 },
                    { 12, 1, "RGB lighting, 16000 DPI", "Gaming Mouse", 49.99m, 120 },
                    { 13, 2, "Fleece, size L", "Hoodie", 34.99m, 65 },
                    { 14, 2, "Denim, slim fit", "Jeans", 44.99m, 90 },
                    { 15, 5, "Lightweight, breathable mesh", "Running Shoes", 75.99m, 55 },
                    { 16, 4, "Wooden, seats six", "Dining Table", 349.99m, 15 },
                    { 17, 4, "5-tier wooden rack", "Bookshelf", 129.99m, 25 },
                    { 18, 4, "3-seater, fabric upholstery", "Sofa", 499.99m, 10 },
                    { 19, 5, "Non-slip, 6mm thick", "Yoga Mat", 19.99m, 100 },
                    { 20, 5, "FIFA quality certified", "Football", 29.99m, 40 }
                });
